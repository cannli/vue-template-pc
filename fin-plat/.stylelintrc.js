module.exports = {
  ...
  plugins: ['stylelint-order', 'stylelint-scss'], // stylelint-order是CSS属性排序插件  '@namics/stylelint-bem'
  rules: {
    // 'plugin/stylelint-bem-namics': {
    //   // namespaces: ['ux-'],
    //   patternPrefixes: [], // a Atom, m Molecule, o Organism, l Layout, g Grid
    //   helperPrefixes: ['is', 'has', 'state'],
    // },
    // overwrite
    ...
    'number-leading-zero': 'always', // 要求或分数低于1的数字禁止前导零
